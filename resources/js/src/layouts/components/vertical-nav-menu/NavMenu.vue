  ...
  >
    ...
    <div class="vertical-nav-header d-flex items-center ps-6 pe-5 pt-5 pb-2">
      <router-link to="/" class="d-flex align-center text-decoration-none">
        <v-img
          :src="require('/images/logos/logo-parabarberos.png')"
          max-height="50px"
          max-width="50px"
          alt="logo"
          contain
        ...
        <v-slide-x-transition>
          <h2 class="app-title text--primary">PARABARBEROS</h2>
        </v-slide-x-transition>
      </router-link>
    </div>
    ...
    <v-list expand shaped class="vertical-nav-menu-items pr-5">
      ...
      <nav-menu-link
        title="Analiticas"
        :to="{ name: 'analytics' }"
        :icon="icons.mdiDatabaseSyncOutline"
      ></nav-menu-link>
      <nav-menu-link
      ...
      <nav-menu-group title="Usuarios" :icon="icons.mdiAccountGroup">
        <nav-menu-link title="Administradores" :to="{ name: 'admins' }"></nav-menu-link>
        <nav-menu-link title="Clientes" :to="{ name: 'clients' }"></nav-menu-link>
      </nav-menu-group>
      <nav-menu-link title="Correos" :to="{ name: 'emails' }" :icon="icons.mdiEmail"></nav-menu-link>
      <nav-menu-link title="Facturas" :to="{ name: 'invoices' }" :icon="icons.mdiAlphaTBoxOutline"></nav-menu-link>
