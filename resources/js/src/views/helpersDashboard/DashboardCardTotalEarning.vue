<template>
  <v-card>
    ...
    <v-card-text class="my-7">
      ...
      <h4 class="mt-2 font-weight-medium">En comparación con $84,325 del año pasado</h4>
    </v-card-text>
...
export default {
  setup() {
    const totalEarning = [
      {
        avatar: require('/images/logos/zipcar.png'),
        title: 'Zipcar',
      ...
      {
        avatar: require('/images/logos/bitbank.png'),
        title: 'Bitbank',
      ...
      {
        avatar: require('/images/logos/aviato.png'),
        title: 'Aviato',
